...
require("normal.set")
require("normal.commands")
require("normal.nvim-tree")
...
vim.keymap.set('n', '<leader>sf', require('telescope.builtin').find_files, { desc = '[S]earch [F]iles' }) -- respect .gitignore
...
local servers = { 'clangd', 'rust_analyzer', 'pyright', 'tsserver', 'lua_ls', 'gopls', 'eslint'}
